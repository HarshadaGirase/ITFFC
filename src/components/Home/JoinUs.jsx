...
const JoinUs = () => {
  return (
    <section className="bg-[#FF8100] py-12 px-8 text-center">
      <h2 className="text-[14px] leading-[30px] sm:text-[14px] sm:leading-[30px] md:text-[40px] md:leading-[50px] lg:text-[40px] lg:leading-[50px] font-bold text-white mb-4 font-quicksand">Join the Movement</h2>
