    ...
    <section className="py-12 px-4 md:px-8 lg:px-[90px] bg-gray-100">
      ...
      <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="bg-white shadow-lg  rounded-xl ">
          ...
          />
          <h3 className="p-6 text-[17px] leading-[20.84px] sm:text-[17px] sm:leading-[20.84px] md:text-[20px] md:leading-[25px]  lg:text-[25px] lg:leading-[32px] font-semibold font-quicksand mb-2">
            Preschool for Neurodiverse Children (Ages 2-6)
          </h3>
          <p className=" p-6 text-black font-intern text-[11px] leading-[13px]  sm:text-[11px] sm:leading-[13px] md:text-[16px] md:leading-[20px] lg:text-[16px] lg: leading-[20px]">
        ...
        <div className="bg-white shadow-lg rounded-lg ">
          <img
            ...
            className="w-full h-48 object-cover rounded-t-lg mb-4"
          />
          <h3 className="p-6 text-[17px] leading-[20.84px] sm:text-[17px] sm:leading-[20.84px] md:text-[20px] md:leading-[25px]  lg:text-[25px] lg:leading-[32px] font-semibold font-quicksand mb-2">Remediation Programs</h3>
          <p className="p-6 text-black font-intern text-[11px] leading-[13px]  sm:text-[11px] sm:leading-[13px] md:text-[16px] md:leading-[20px] lg:text-[16px] lg: leading-[20px]">
